...
#define AUX1_Button KEY_B // hold this button and use encoder left/right to adjust PWM output on port
...
#define AUX2_Button KEY_C // hold this button and use encoder left/right to adjust PWM output on port
...
#define AUX3_Button KEY_D // hold this button and use encoder left/right to adjust PWM output on port
