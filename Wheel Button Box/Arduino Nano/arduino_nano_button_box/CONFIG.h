 ...
 */
 ...
 #define Button_10_Pin A0
 #define Button_11_Pin A1
 #define Button_12_Pin A2
 ...
 */
 #define Joystick_1_Pin A6       // must be A6 or A7 since these will not work with INPUT_PULLUP
 ...
 #define Joystick_2_Pin A7       // must be A6 or A7 since these will not work with INPUT_PULLUP
